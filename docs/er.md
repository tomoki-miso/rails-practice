...
erDiagram
  ...
  preparation_completions {
    int id PK
    int session_id FK "UNIQUE(session_id, user_id)"
    int user_id FK
    timestamp completed_at "予習完了日時"
  }
  ...
  comments {
    ...
    int page "ページ"
    int type "0:問い 1:気付き 2:感想 3:雑学 4:その他"
    string content "内容"
  }
  ```
